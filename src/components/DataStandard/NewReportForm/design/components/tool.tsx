...
const ToolBar: React.FC<IProps> = ({ cellStyle, handClick }: IProps) => {
  ...
  useEffect(() => {
    ...
    setBackground(styles?.backgroundColor ? styles.backgroundColor : background);
    setColor(styles?.color ? styles.color : color);
  ...
  const alignHorizontal: any = [
    ...
    {
      label: '居中',
      icon: 'data:image/svg+xml;base64,',
      value: 'center',
      className: 'htCenter',
      type: 'horizontal',
    },
    ...
    <div className={cls['toolbar-start-tab']} key={tkey}>
      <div className={cls['flex-box']}>
        ...
        <div className={cls['row-two']}>
          <Button onClick={() => handClick('', 'importTemplate')}>导入</Button>
        </div>
      </div>
      <div className={cls['flex-box']}>
        <div className={cls['row-one']}>
        ...
        <div className={cls['row-two']}>
          ...
          <div className={cls['color-box']}>
            ...
            <Popover
              ...
              content={content}
              trigger="click">
              <div className={`${cls['icon-a']} ${cls['pt-4']}`}>
          ...
          <div className={cls['color-box']}>
            <div className={cls['color-dropdown']}>
              <a className={cls['icon-a']} title="字体颜色" onClick={setColors}>
