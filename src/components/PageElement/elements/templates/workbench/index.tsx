    ...
    return (
      <div className="workbench-content">
        ...
        <Grid
          ...
          {props.CustomModule && <div key="CustomModule">{props.CustomModule({})}</div>}
          {props.appData && <div key="appData">{props.appData({})}</div>}
      ...
      layouts: {
        ...
        default: {
          lg: [
            ...
            { w: 12, h: 15, x: 0, y: 44, i: 'appData', moved: false, static: false },
            { w: 12, h: 15, x: 0, y: 88, i: 'CustomModule', moved: false, static: false },
          ...
          md: [
            ...
            { w: 10, h: 24, x: 0, y: 52, i: 'appData', moved: false, static: false },
            { w: 10, h: 24, x: 0, y: 60, i: 'CustomModule', moved: false, static: false },
          ...
          sm: [
            ...
            { w: 6, h: 22, x: 0, y: 52, i: 'appData', moved: false, static: false },
            { w: 6, h: 24, x: 0, y: 60, i: 'CustomModule', moved: false, static: false },
          ...
          xs: [
            ...
            { w: 4, h: 22, x: 0, y: 79, i: 'appData', moved: false, static: false },
            { w: 6, h: 24, x: 0, y: 85, i: 'CustomModule', moved: false, static: false },
          ...
          xxs: [
            ...
            { w: 2, h: 22, x: 0, y: 94, i: 'appData', moved: false, static: false },
            { w: 4, h: 24, x: 0, y: 100, i: 'CustomModule', moved: false, static: false },
