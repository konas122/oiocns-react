...
const Index: React.FC = () => {
  ...
  return (
    <div className="privacy_wrap">
      <h3>{resources.platName} 隐私政策</h3>
      <div>
        本政策仅适用于{resources.platName}产品或服务。最近更新日期：2023年01月01日。
      </div>
      <div>
        {resources.platName}
        尊重并保护所有使用服务用户的个人隐私权。为了给您提供更准确、更有个性化的服务，
        {resources.platName}
        会按照本隐私权政策的规定使用和披露您的个人信息。但我们将以高度的勤勉、审慎义务对待这些信息。除本隐私权政策另有规定外，在未征得您事先许可的情况下，
        {resources.platName}
        不会将这些信息对外披露或向第三方提供。我们会不时更新本隐私权政策。您在同意本软件服务使用协议之时，即视为您已经同意本隐私权政策全部内容。本隐私权政策属于本软件服务使用协议不可分割的一部分。
      </div>
      <div> 本政策将帮助您了解以下内容：</div>
      <ul>
        <li className={'flex flex-direction-col'}>
          <strong> 一、我们如何收集和使用您的用户信息</strong>
          <strong> 二、我们如何使用 Cookie 和APP基础权限说明</strong>
          <strong> 三、我们如何共享、转让、公开披露您的用户信息</strong>
          <strong> 四、我们如何保护您的用户信息</strong>
          <strong> 五、您的权利 </strong>
          <strong> 六、我们如何处理儿童的个人信息</strong>
          <strong> 七、您的用户信息如何储存及如何在全球范围转移</strong>
          <strong> 八、本政策如何更新</strong>
          <strong> 九、账户注销流程</strong>
          <strong> 十、如何联系我们</strong>
        </li>
        <li>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <li>
          <strong>二、我们如何使用 Cookie 和基础权限说明</strong>
          （一）Cookie为确保网站正常运转，我们会在您的计算机或移动设备上存储名为 Cookie
          的小数据文件。Cookie 通常包含标识符、站点名称以及一些号码和字符。借助于
          Cookie，网站能够存储您的访问偏好数据。 我们不会将Cookie
          用于本政策所述目的之外的任何用途。您可根据自己的偏好管理或删除
          Cookie。您可以清除计算机上保存的所有 Cookie，大部分网络浏览器都设有阻止Cookie
          的功能。但如果您这么做，则需要在每一次访问我们的网站时亲自更改用户设置。 <br />
          （二）网站信标和像素标签 除Cookie
          ...
          <br />
          （三）DoNot Track（请勿追踪）很多网络浏览器均设有Do Not
          ...
          <table border={1} width={'100%'}>
            ...
            <tr>
              ...
              <td>从外部存储读取数据，基础数据存储能力</td>
            </tr>
            <tr>
              <td>存储</td>
              <td>WRITE_EXTERNAL_STORAGE</td>
              <td>写入数据到外部存储，技术数据读取能力</td>
            </tr>
            <tr>
              <td>相机</td>
              <td>CAMERA</td>
              <td>使用摄像头进行拍照或录制视频，用户上传图片发布信息等</td>
            </tr>
          </table>
        </li>
      </ul>
      ...
      <strong> 四、我们如何保护您的用户信息</strong>
      （一）我们已使用符合业界标准的安全防护措施保护您提供的用户信息，防止数据遭到未经授权的访问、公开披露、使用、修改、损坏或丢失。我们会采取一切合理可行的措施，保护您的用户信息。例如，在您的浏览器与“服务”之间交换数据时受SSL
      加密保护；
      <p>
        我们同时对网站提供https安全浏览方式；
        <br />
        我们会使用加密技术确保数据的保密性；
        <br />
        我们会使用受信赖的保护机制防止数据遭到恶意攻击；
        <br />
        我们会部署访问控制机制，确保只有授权人员才可访问用户信息；
        <br />
        以及我们会举办安全和隐私保护培训课程，加强员工对于保护用户信息重要性的认识。
      </p>
      ...
      （一）访问您的用户信息您有权访问您的用户信息，法律法规规定的例外情况除外。如果您想行使数据访问权，可以通过以下方式自行访问：补充用户信息访问方式如果您无法通过上述链接访问这些用户信息，您可以随时使用我们的
      Web
      表单联系，或发送电子邮件至指定邮箱。我们将在30天内回复您的访问请求。对于您在使用我们的产品或服务过程中产生的其他用户信息，只要我们不需要过多投入，我们会向您提供。
      <br />
      （二）更正您的用户信息 <br />
      当您发现我们处理的关于您的用户信息有错误时，您有权要求我们作出更正。您可以通过访问您的”用户信息”中罗列的方式提出更正申请。如果您无法通过上述链接更正这些用户信息，您可以随时使用我们的
      Web 表单联系，或发送电子邮件至指定邮箱。我们将在30天内回复您的更正请求。
      <br />
      （三）删除您的用户信息在以下情形中，您可以向我们提出删除用户信息的请求： <br />
      <p>
        ...
        <br />
        5、如果我们不再为您提供产品或服务。我们将会根据您的删除请求进行评估，若满足相应规定，我们将会采取相应步骤进行处理。当您向我们提出删除请求时，我们可能会要求您进行身份验证，以保障账户的安全。当您从我们的服务中删除信息后，因为适用的法律和安全技术，我们可能不会立即从备份系统中删除相应的信息，我们将安全存储您的信息直到备份可以清除或实现匿名化。
      </p>
      ...
      14
      周岁的任何人均视为儿童。对于经父母或监护人同意而收集儿童用户信息的情况，我们只会在受到法律允许、父母或监护人明确同意或者保护儿童所必要的情况下储存、使用或公开披露此信息，否则我们会设法尽快删除相关数据。鉴于现有技术和业务模式的限制，我们很难主动识别儿童的个人信息，如果您发现我们在不知情的情况下或在未事先获得可证实的监护人同意的情况下收集了儿童的个人信息，您可以及时联系我们，我们将在发现后设法及时删除，如果我们自己发现前述情形的，我们也会及时删除，法律要求我们保留的除外。
      <br />
      <strong> 七、您的用户信息如何储存以及如何在全球范围转移</strong>
      ...
      <strong> 八、本政策如何更新我们的隐私政策可能变更。</strong>
      <p>
      ...
      <strong> 九、用户注销。</strong>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;账户注销流程，如果您不想继续享受我们提供的服务，您可以联系我们账号专员进行注销账号，如满足条件，将会在7天内完成注销；
      <strong>
        十、如何联系我们，如果您对本隐私政策有任何疑问、意见或建议，通过以下方式与我们联系：
      </strong>
      <p>
        技术支持：杭州电子科技大学资产云开放协同创新中心 <br />
